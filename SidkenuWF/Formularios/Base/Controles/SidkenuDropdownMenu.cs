...
public class SidkenuDropdownMenu : ContextMenuStrip
{
    //Fields
    ...
    //Constructor
    public SidkenuDropdownMenu(IContainer container)
        : base(container)
    {
    ...
    protected override void OnHandleCreated(EventArgs e)
    {
        ...
        {
            this.Renderer = new SidkenuMenuRenderer(isMainMenu, primaryColor, menuItemTextColor);
            LoadMenuItemHeight();
        }
    }
}
