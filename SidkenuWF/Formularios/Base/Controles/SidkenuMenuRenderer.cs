...
public class SidkenuMenuRenderer : ToolStripProfessionalRenderer
{
    //Fields
    ...
    //Constructor
    public SidkenuMenuRenderer(bool isMainMenu, Color primaryColor, Color textColor)
        : base(new SidkenuMenuColorTable(isMainMenu, primaryColor))
    {
